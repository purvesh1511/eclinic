...
class CustomersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('customer::backend.customers.index', compact('module_action', 'import_columns', 'columns', 'import_url', 'customefield', 'export_import', 'export_columns', 'export_url', 'patients', 'patientNames', 'email', 'contact'));
    }
