...
class Appointment extends BaseModel
{
    ...
    protected $fillable = ['status', 'start_date_time', 'user_id', 'clinic_id', 'doctor_id', 'appointment_extra_info', 'appointment_date', 'appointment_time', 'service_id', 'total_amount', 'service_amount', 'service_price', 'duration', 'advance_payment_amount', 'advance_paid_amount'];
