...
class ClinicAppointmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('appointment::backend.clinic_appointment.index_datatable', compact('service', 'module_action', 'filter', 'columns', 'customefield', 'export_import', 'export_columns', 'import_columns', 'export_url', 'import_url', 'export_doctor_id', 'doctor', 'user_id', 'doctor_id', 'clinic_id'));
    }
