...
class PathologyEarningsController extends Controller
{
    // use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'earning.lbl_pathology_earnings';
        // module name
        $this->module_name = 'pathologyearnings';
    ...
    public function index(Request $request)
    {
        ...
        $export_url = route('backend.pathologyearnings.export');

        return view('earning::backend.pathologyearnings.index_datatable', compact('module_action', 'filter', 'columns', 'customefield', 'export_import', 'export_columns', 'export_url'));
    }
