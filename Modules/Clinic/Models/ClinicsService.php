...
class ClinicsService extends BaseModel
{
     ...
     */
    protected $fillable = ['system_service_id','name','description','type','is_video_consultancy','charges','category_id','subcategory_id','vendor_id','duration_min','time_slot','discount','discount_value','discount_type','status','service_type','is_enable_advance_payment','advance_payment_amount'];
