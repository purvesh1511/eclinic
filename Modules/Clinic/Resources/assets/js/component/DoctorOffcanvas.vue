      ...
      <div class="offcanvas-body">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <InputField type="text" :label="$t('clinic.lbl_postal_code')" :placeholder="$t('clinic.lbl_postal_code')" v-model="pincode" :error-message="errors['pincode']" :error-messages="errorMessages['pincode']"> </InputField>
          </div>
          <div class="col-md-6">
            <div class="form-group">
