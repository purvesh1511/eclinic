        ...
        <div class="row">
          ...
          <div class="col-md-6" v-if="is_enable_advance_payment">
            <div class="form-group">
              ...
              <InputField type="text" :is-required="true" :label="$t('service.advance_payment_amount')" :placeholder="$t('service.advance_payment_amount')"  v-model="advance_payment_amount" :error-message="errors['advance_payment_amount']" :error-messages="errorMessages['advance_payment_amount']"></InputField>
            </div>
          </div>
...
discount_value: yup.number().typeError('Discount value must be a number')
  ...
  // advance_payment_amount: yup.string().test('advance_payment_amount', "Advanced payment is a required field", function(value) {
  //   if (is_enable_advance_payment && !value) {
  //       return false;  
  //     }
  //     return true; 
  // }),
